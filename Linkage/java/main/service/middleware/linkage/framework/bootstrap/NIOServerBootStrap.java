...
import service.middleware.linkage.framework.handlers.NIOMessageServiceReadWriteHandler;
...
public class NIOServerBootStrap extends AbstractBootStrap implements Runnable {
	...
	public NIOServerBootStrap(String propertyPath, int serviceTaskThreadPootSize) throws Exception{
		...
		// to handle further
		this.getEventDistributionHandler().registerHandler(new NIOMessageServiceReadWriteHandler(serviceProvider));
